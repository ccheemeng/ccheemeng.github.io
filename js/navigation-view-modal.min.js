!(function () {
  ...
  function d(e) {
    ...
    e.classList.toggle("has-modal-open", !o),
      t.toggleAttribute("aria-modal", !o),
      o
        ? (t.removeAttribute("role"), t.removeAttribute("aria-modal"))
        : (t.setAttribute("role", "dialog"),
          t.setAttribute("aria-modal", "true"));
    document.documentElement.classList.toggle("has-modal-open");
  }
  window.addEventListener("load", () => {
    c.init({ onShow: d, onClose: d, openClass: "is-menu-open" });
    document
      ...
      .forEach(function (e) {
        ...
        if (
          ...
          o.search !== window.location.search ||
          "_blank" ===
            (null === (t = e.attributes) || void 0 === t ? void 0 : t.target)
        )
          return;
